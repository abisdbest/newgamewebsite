                        ...
                        ? ((e = (o = o || {}).headers || {}),
                          ...
                          n.headers.get("Last-Modified")
                            ...
                            : n.headers.get("ETag") &&
                              ...
                              (e["Cache-Control"] = "no-cache")),
                          s(r, o))
                        : fetch(i.result.url, { method: "HEAD" }).then(
                            function (t) {
                              return (
                                (i.revalidated = [
                                  "Last-Modified",
          ...
          n = {
            "inflate.js": function (e, t, n) {
              ...
              (i.prototype.push = function (e, t) {
                ...
                return (r = n === b.Z_STREAM_END ? b.Z_FINISH : r) ===
                  b.Z_FINISH
                  ? ((n = c.inflateEnd(this.strm)),
                    this.onEnd(n),
                    (this.ended = !0),
                    n === b.Z_OK)
                  : r !== b.Z_SYNC_FLUSH ||
