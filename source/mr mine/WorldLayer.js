...
class WorldLayer extends UiLayer {
    ...
    renderMoonbase() {
        if (currentlyViewedDepth > 1027 && currentlyViewedDepth < 1037) {
            ...
            MAIN.lineWidth = 2;
            MAIN.font = MAIN.canvas.width * 0.0125 + "px KanitM";
            strokeTextShrinkToFit(MAIN, tickets, Math.ceil(mainw * .549), Math.floor(mainh * .719) * ((4 - (currentlyViewedDepth - 1032)) / 4) - Math.ceil(mainh * .215), mainw * .080, "center", .25);
            fillTextShrinkToFit(MAIN, tickets, Math.ceil(mainw * .549), Math.floor(mainh * .719) * ((4 - (currentlyViewedDepth - 1032)) / 4) - Math.ceil(mainh * .215), mainw * .080, "center", .25);
            MAIN.restore();
        }
    }
    ...
    renderTitanbase() {
        if (currentlyViewedDepth > 1809 && currentlyViewedDepth < 1819) {
            ...
            MAIN.lineWidth = 2;
            MAIN.font = MAIN.canvas.width * 0.0125 + "px KanitM";
            strokeTextShrinkToFit(MAIN, tickets, Math.ceil(mainw * .587), Math.floor(mainh * .755) * ((4 - (currentlyViewedDepth - 1814)) / 4) - Math.ceil(mainh * .215), mainw * .080, "left", .25);
            fillTextShrinkToFit(MAIN, tickets, Math.ceil(mainw * .587), Math.floor(mainh * .755) * ((4 - (currentlyViewedDepth - 1814)) / 4) - Math.ceil(mainh * .215), mainw * .080, "left", .25);
            MAIN.restore();
        }
    }
