class CaveSystem {
    ...
    replaceNodeWithObstacle(nodeId, obstacleType) {
        ...
        switch (obstacleType) {
            case "rock":
                newNode = new CaveBlockerRock();
                break;
            case "mud":
                newNode = new CaveTerrainMud();
                break;
            case "radiation":
                newNode = new CaveHazardRadiation();
                break;
            case "lava":
                newNode = new CaveHazardLava();
                break;
            default:
                console.error("Unknown obstacle type:", obstacleType);
                return false;
        }
