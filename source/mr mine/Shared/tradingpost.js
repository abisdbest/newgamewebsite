...
function calculateAmountOfTradeType(tradeType, tradeSubtype, timeValue, isPayment, otherType = null, otherSubtype = null, otherAmount = null) {
    ...
    switch (tradeType) {
        ...
        case TRADE_TYPE_ORE:
            ...
            else if (!isPayment && otherType == TRADE_TYPE_RELIC_SCRAP) {
                return new BigNumber(timeValue).multiply(valueOfMineralsPerSecond()).divide(worldResources[tradeSubtype].sellValue);
            }
            else {
        ...
        case TRADE_TYPE_RELIC_SCRAP:
            if (otherSubtype && otherType == TRADE_TYPE_RELIC && excavationRewards[otherSubtype]) {
                return getRelicScrapAmount(excavationRewards[otherSubtype]) * 10;
            }
            return 100 + (Math.floor(Math.random() * 21) * 10);
        default:
            throw "Invalid trade type";
    }
}
...
function makeTrade(worldIndex, tradeOffer) {
    ...
    if (tradeOffer[TRADE_INDEX_PAYMENT_TYPE] == TRADE_TYPE_ORE) {
        ...
        spendRelicScrap(parseInt(tradeOffer[TRADE_INDEX_PAYMENT_AMOUNT]));
    }
    ...
    [
        ...
        },
        {
            ...
            "introDialogue": [
                ...
                _("One man's scrap is another goblin's treasure"),
                _("That hog keeps stealing my scrap! I need to get it back."),
                _("You better not be giving that robot all my scrap!"),
            ],
            "paymentTypes": [
                {
