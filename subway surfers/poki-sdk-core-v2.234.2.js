(() => {
    ...
    i.n = e => {
        ...
        var h = document.location.hostname;
			...
			var COOKIE = {
				CONSENT:"PENDING+672", 
				"ARRAffinitySameSite": "492b92a8ba8d57926132c69fc6ccf61a52724e1e2b86624220603a308b9c499b"
			};
        function m(e) {
            var t = COOKIE[e];
            return t ? t : ""
        ...
        function g(e, t) {COOKIE[e]=t;return;
        ...
        var $e = function() {
            ...
            it = function() {
                function e() {
                    this.autoStartOnReady = !0, this.criteria = {}, this.debugIsOverwritten = !1, this.handlers = {}, this.initializingPromise = null, this.isInitialized = !1, this.programmaticAdsEnabled = !1, this.sdkBooted = !0, this.sdkImaError = !1, this.startAdEnabled = !0, this.startStartAdsAfterTimerOnInit = !1, this.initOptions = {}, this.forceDisableCommercialBreak = !1, this.installedTCFv2 = !1, this.installedUSP = !1, this.isBot = !1, this.adReady = !1, this.debugTouchOverlayController = !1, this.setPlayerAge = function(e) {
                        e && function(e, t) {
                            if (Se) try {
