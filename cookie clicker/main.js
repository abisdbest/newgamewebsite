...
Game.Launch=function()
{
	...
	'<div class="listing">'+(EN?
		'We have an <a href="https://discordapp.com/invite/" target="_blank">official Discord</a>; if you\'re looking for help, you may also want to visit the <a href="https://www.reddit.com/r/CookieClicker" target="_blank">subreddit</a> or the <a href="https://cookieclicker2.wikia.com/wiki/Cookie_Clicker_Wiki" target="_blank">wiki</a>.<br>News and teasers are usually posted on Orteil\'s <a href="https://cookieclickernew.tumblr.com/" target="_blank">tumblr</a> and <a href="https://twitter.com/cookieclicker" target="_blank">twitter</a>.'
		:
		loc("Useful links: %1, %2, %3, %4.",[
		'<a href="https://discordapp.com/invite/" target="_blank" class="highlightHover smallBlackButton">Discord</a>',
		'<a href="https://2.wikia.com/wiki/" target="_blank" class="highlightHover smallBlackButton">wiki</a>',
				...
				str+=
					'<div class="block" style="padding:0px;margin:8px 4px;">'+
						...
						'<div class="title">'+loc("General")+'</div>'+
							...
							'<div class="listing"><a class="option smallFancyButton" '+Game.clickStr+'="Game.toSave=true;PlaySound(\'snd/tick.mp3\');">'+loc("Save")+'</a><label>'+loc("Save manually (the game autosaves every 60 seconds; shortcut: ctrl+S (⌘ Cmd + S))")+'</label></div>'+
