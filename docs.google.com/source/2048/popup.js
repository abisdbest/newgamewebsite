...
KeyboardInputManager.prototype.listen = function () {
  ...
  var gameContainer = document.getElementsByClassName("puzzleWrapper")[0];
...
window.ABStorage = {
  setItem: function (id, val) {
    return localStorage.setItem(id, String(val));//this._data[id] = String(val);
  },

  getItem: function (id) {
    return localStorage.getItem(id);//this._data.hasOwnProperty(id) ? this._data[id] : undefined;
  },
...
GameManager.prototype.setup = function () {
  ...
  if (previousState) {
    ...
    if (this.storageManager.isItFirstLaunch())
    {
        ...
        lesson.className = "start-lesson";
        lesson.addEventListener("click", function() {
            this.remove();
        });
        document.addEventListener("keydown", function removeLesson() {
            lesson.remove();
