...
function removeSpeedReadDiv() {
    ...
    if (div) {
        ...
        divCreated = true; // Reset flag to false
...
var timeUntilNextMinute = 60000 - (now.getTime() % 60000);
...
function checkTime() {
    ...
    startTime.setHours(11, 35, 0); // 19:05:00

    var endTime = new Date();
    endTime.setHours(12, 20, 0); // 20:45:00
    ...
    // Calculate the time until the next minute
    timeUntilNextMinute = 60000 - (now.getTime() % 60000);
}
...
setInterval(checkTime, timeUntilNextMinute);
...
var this_is_the_new_code1234 = "hiufwyr.kuzy,kruzlsiwujhglzi8ewur,kwueryo;aw46246aw8i8eyiwy5uwyrfkzuegrkuaw7tswu5"
